...
namespace FX.OpenXmlServer.WordHelpers
{
    ...
    public class WordHelper
    {
        ...
        public OpenXmlElement CreateParagraph(string text, Config config)
        {
            ...
            {
                rPrForPar.Append(new FontSize() { Val = config.FontSize.ToString() });
                rPrForPar.Append(new FontSizeComplexScript() { Val = config.FontSize.ToString() });
            }
            ...
            if (config.FontSize != null)
            {
                rPrForOxe.Append(new FontSize() { Val = config.FontSize.ToString() });
            }
